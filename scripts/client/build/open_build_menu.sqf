        ...
        lbClear 110;
        {
            ...
            if (buildtype != 8) then {
                ...
                switch (_classnamevar) do {
					...
					case "cwr3_b_soldier": {_entrytext = localize "STR_Infantry_USA";};
					case "cwr3_b_soldier82": {_entrytext = localize "STR_Infantry_USA82";};
					case "cwr3_b_ranger": {_entrytext = localize "STR_Infantry_USAAB";};
					case "cwr3_b_uk_soldier": {_entrytext = localize "STR_Infantry_UK";};
					case "cwr3_b_usmc_soldier": {_entrytext = localize "STR_Infantry_USMC";};
					case "cwr3_o_soldier": {_entrytext = localize "STR_Infantry_SOV85";};
					case "cwr3_o_soldier82": {_entrytext = localize "STR_Infantry_SOV82";};
					case "cwr3_o_spetsnaz": {_entrytext = localize "STR_Infantry_SOVSPETSNAZ";};
					case "CUP_B_M1A1SA_Woodland_US_Army": {_entrytext = localize "STR_Armor_M1A1SA";};
					case "CUP_B_UH1D_slick_GER_KSK": {_entrytext = localize "STR_Air_UH1_BW";};
					case "cwr3_b_usmc_uh1": {_entrytext = localize "STR_Air_UH1_USMC";};
					case "cwr3_b_usmc_ah1f": {_entrytext = localize "STR_Air_AH1_USMC";};
					case "cwr3_b_ah64": {_entrytext = localize "STR_Air_AH64";};
					case "cwr3_b_ah64_hellfire": {_entrytext = localize "STR_Air_AH64_Hellfire";};
					case "CUP_B_GR9_DYN_GB": {_entrytext = localize "STR_Air_GR9";};
                    case "Flag_White_F": {_entrytext = localize "STR_INDIV_FLAG";};
					case "Land_PaperBox_closed_F": {_entrytext = localize "STR_BuildingSupply";};
                    case "Land_Photos_V1_F": {_entrytext = localize "STR_PHOTO1_MAGAZINE";};
                    case "Land_Photos_V6_F": {_entrytext = localize "STR_PHOTO6_PINUP";};
