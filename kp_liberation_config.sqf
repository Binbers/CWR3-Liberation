...
GRLIB_save_key = "KP_LIBERATION_west" + (toUpper worldName) + "_SAVEGAME";
...
GRLIB_secondary_objective_impact = 1.15;                                // The percentage impact against enemy combat readiness for a successful FOB hunt.
...
GRLIB_sector_cap = 200;                                                 // Cap for sector defenders.
...
KP_liberation_convoy_ambush_duration = 900;                            // Duration of the convoy ambush event. (seconds)
