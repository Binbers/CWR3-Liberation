...
KPLIB_b_allSquads = [
    ...
    [blufor_squad_inf,90,0,0],
    [blufor_squad_at,60,50,0],
    [blufor_squad_aa,60,50,0],
    [blufor_squad_recon,80,0,0],
...
KPLIB_crates            = [KP_liberation_supply_crate, KP_liberation_ammo_crate, KP_liberation_fuel_crate, Arsenal_typename];
